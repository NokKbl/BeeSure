...
$(document).ready(function() {
    ...
    rangeSlider2.noUiSlider.on('update', function(values, handle) {
        ...
        document.getElementById('min-value-2').value = moneyFormat.from(
          values[0]);
        document.getElementById('max-value-2').value = moneyFormat.from(
          values[1]);
      });

    //   rangeSlider3.noUiSlider.on('update', function(values, handle) {
    //     document.getElementById('slider-range-3-value1').innerHTML = values[0];
    //     document.getElementById('slider-range-3-value2').innerHTML = values[1];
    //     document.getElementById('min-value-3').value = moneyFormat.from(
    //       values[0]);
    //     document.getElementById('max-value-3').value = moneyFormat.from(
    //       values[1]);
    //   });
  });
