...
const mockData = [
  ...
  },
  {
    ...
    img: "logo_bangkokB.png",
    id: "bangkokBankElite1",
    webUrl:
    ...
    <div class="modal-content bg-light\">
      ...
      <div class="modal-body">
        ...
        <table class="table table-bordered">
          <thead>
            <tr>
              <th style="width:70%">Protection</th>
...
backToHome = () => {
  window.location.href = `selectInsurance.html?theme=${currentTheme}`;
};
